...
from selenium_tools.discord import login_discord, invite_discord, notables_discord
...
if __name__ == '__main__':
    failed = []
    for num_idx in range(len(discord_token)):
